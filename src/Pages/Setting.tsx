...
const Setting = () => {
  ...
  return (
    <>
      <div className=" lg:p-6 bg-slate-50 lg:flex-none lg:min-h-screen ">
        <div className="max-w-6xl mx-auto">
          <span className="text-2xl font-extrabold">Settings</span>
          <p className="text-gray-600 ">
            Manage Your Account Settings And System Perferences.
          </p>
        </div>
                  ...
                  <div className="m-3">
                    ...
                    <div className="mt-10">
                      <div className="m-6 flex justify-between items-center bg-amber-200/50 p-4 rounded-2xl">
                        ...
                        <div>
                          <button
                            className="bg-white px-4 py-2 rounded-xl font-bold text-orange-500/90 border border-orange-600 cursor-pointer"
                      ...
                      <div className="m-6">
                        ...
                        <div className="flex justify-between items-center bg-red-300/80 p-4 rounded-2xl">
                          <span>
                            Permanently delete all project and Employee data.
                          </span>
                          <button
                            className="bg-red-500/90 px-3 py-2 rounded-xl font-semibold cursor-pointer"
                            onClick={() => setShwpopup(true)}
                          >
                            Reset Database
                          </button>
                        </div>
